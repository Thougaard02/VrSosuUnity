...
public class OVRGrabber : MonoBehaviour
{
    ...
    {
        public static List<IPickedUp> pickedUps = new List<IPickedUp>();
        

        public static void AddLisinger(IPickedUp pickedUp)
        {
            pickedUps.Add(pickedUp);
        }
        public static void ItemPickedUp(GameObject _gameObject)
        {
            foreach (IPickedUp item in pickedUps)
            {
                item.PickedUp(_gameObject);
            }
        }
    ...
    {
        void PickedUp(GameObject _gameObject);
    }
}
